...
import MAS from '../images/SponsorLogos/MAS_LOGO.png';
    ...
    <Container className="">
      <Row className="px-3 px-lg-0 justify-content-center">
        <Title>Our Sponsors</Title>
            <SponsorCard image={MAS} title={'Empowering Partner'} wh={'w-100'}/>
            ...
            <SponsorCard image={Perabeats} title={'Media Partner'} wh={'h-100 text-center'}/>
